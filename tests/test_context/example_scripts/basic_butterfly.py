...
@wildered.autocomplete(requirement="Please complete this function", modify=True)
...
@wildered.autocomplete(requirement="Please complete this function", rewrite_docs=False)
class DummyClass1:
