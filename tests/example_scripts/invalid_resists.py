...
# ERROR: Resist world directives
# NOTE: Will raise require directive error first if both resist and require directives are not satisfied.
@world.world(dummy="there")
@world.hello()
@world.function_only(dummy="hello")
