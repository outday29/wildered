...
def test_update_imports(parser: BaseDirectiveParser):
    orig = read_file("./tests/test_source_code/example_scripts/old_imports.py")
    
    source = ASTSourceCode.from_file("./tests/test_source_code/example_scripts/old_imports.py")
    ...
    assert read_file("./tests/test_source_code/example_scripts/old_imports.py") == orig
